...
import { FaGithub, FaStackExchange } from "react-icons/fa";
        ...
        <section className={styles.topitem}>
          ...
          <div className={styles.buttons}>
            <button
              ...
              onClick={() =>
                window.open(
                  "https://jupiter.agg/swap/?outputCurrency=GsFjUCEsRwXHyahR8XsnnJYrgxBjADwnNJ1wbJbGdMVK",
                  "_blank"
                )
              }
            >
              <MdToken className={styles.icon5} /> Buy BARK
            </button>
            <button
          ...
          <section className={styles.section2}>
            ...
            <div className={styles.content2}>
              ...
              <button className={styles.stakeUnstakeButton}>
                {previousAction === "stake" ? "Unstake" : "Stake BARK"}
              </button>
            </div>
          </section>
